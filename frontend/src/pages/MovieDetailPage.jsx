...
export function MovieDetailPage() {
  ...
  const movie = {
    ...
    daysOfShows: ["2026-06-12", "2026-06-13"],
    ...
    description: "Đạo diễn: Yeon Sang-ho",

    content:
      "Lấy bối cảnh Hồng Kông thập niên 1930, Yên Chi Khâu kể về mối tình đầy ngang trái giữa Trần Chấn Bang - Thập Nhị Thiếu Gia (Trương Quốc Vinh thủ vai) — vị thiếu gia ăn chơi của một gia tộc quyền thế — và Như Hoa (Mai Diễm Phương thủ vai), một kỹ nữ nổi tiếng. Vì bị gia đình ruồng bỏ và ngăn cản quyết liệt, cặp đôi tuyệt vọng đã cùng nhau lập một lời thề tự sát để được bên nhau mãi mãi. Tuy nhiên, định mệnh trớ trêu khi Chấn Bang lại không đủ can đảm để thực hiện lời hứa đó. 50 năm sau, linh hồn Như Hoa vẫn mòn mỏi đợi chờ và quay trở lại một Hồng Kông hiện đại, phồn hoa để tìm kiếm người tình. Tại đây, cô bàng hoàng nhận ra Chấn Bang giờ chỉ còn là một ông lão tiều tụy, sống kiếp tầm gửi, nghèo khổ và tẻ nhạt. Khi thời gian sắp cạn kiệt, Như Hoa phải đối mặt với cơ hội cuối cùng để kiểm chứng sự thủy chung và lòng tận hiến của người đàn ông cô từng hết mực yêu thương. Đầy đam mê, cảm động và được thực hiện một cách tinh tế, Yên Chi Khâu là tác phẩm kinh điển không thể bỏ qua đối với những khán giả của điện ảnh nghệ thuật.",
            ...
            <div className="snack-and-drink-list-container">
              <div className="snack-and-drink-item">
                ...
                <div className="item-detail">
                  ...
                  <p className="desc">
                    1 Coke 32oz + 1 Bắp 2 Ngăn 64OZ Phô Mai + Caramel * Vùng 1
                  </p>
              ...
              <div className="snack-and-drink-item">
                ...
                <div className="item-detail">
                  ...
                  <p className="desc">
                    2 Coke 32oz + 1 Bắp 2 Ngăn 64OZ Phô Mai + Caramel * Vùng 1
                  </p>
              ...
              <div className="snack-and-drink-item">
                ...
                <div className="item-detail">
                  <p className="name">Combo gấu</p>
                  <p className="desc">
                    4 Coke 32oz + 2 Bắp 2 Ngăn 64OZ Phô Mai + Caramel * Vùng 1
                  </p>
